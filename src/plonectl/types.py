...
def nested_dataclass(*args, **kwargs):
    """Decorator to create a dataclass that has other dataclasses as attributes."""
...
class InstanceSettings:
    ...
    # ZCML
    zcml_package_metas: field(default_factory=list)
    zcml_package_includes: field(default_factory=list)
    zcml_package_overrides: field(default_factory=list)
    zcml_locales_directory_location: str
    zcml_include_file_location: str
    zcml_overrides_file_location: str
    zcml_resources_directory_location: str
