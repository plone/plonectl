...
from .run import typer_app as app_run
from .server import typer_app as app_server
from .shell import typer_app as app_shell
...
cli.add_typer(app_run, name="run", no_args_is_help=True, help="Run a script")
cli.add_typer(app_server, name="server", no_args_is_help=True, help="Server Management")
cli.add_typer(
    app_shell, name="shell", no_args_is_help=True, help="Start an interactive shell"
)
